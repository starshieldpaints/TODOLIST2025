...
// import { Portal, Modal, Card, Text, IconButton, TextInput } from 'react-native-paper';
...
//         const updatedTasks = selectedUser.tasks.filter(task => task.taskId !== taskId);
//         selectedUser.tasks = updatedTasks;
//     };
...
//     //     // Add new remark to the front of the array
...
//         );
//         selectedUser.tasks = updatedTasks; // mutate local object
//         setRemarkText('');
//         setRemarkModalVisible(false);
//     };
...
//                 visible={visible}
//                 onDismiss={onDismiss}
//                 contentContainerStyle={[styles.modalContent, { backgroundColor: theme.colors.card, maxHeight: height * 0.8 }]}
//             >
...
//                                         <Ionicons name="list-circle-outline" size={20} color={theme.colors.primary} style={{ marginRight: 8 }} />
...
//                                         <Text style={{ color: isOverdue ? '#FF3B30' : theme.colors.text, fontSize: 14 }}>
...
//                                     {/* Description */}
//                                     <View style={styles.row}>
//                                         <Ionicons name="document-text-outline" size={16} color={theme.colors.text} style={{ marginRight: 6, marginTop: 2 }} />
//                                         <Text style={{ color: theme.colors.text, fontSize: 14 }}>{task.description}</Text>
//                                     </View>
...
//                                                 <Text style={{ fontSize: 12, color: '#333' }}>{remark}</Text>
//                                             </View>
//                                         ))}
//                                     </View>
...
//                                             <Ionicons name="swap-vertical" size={16} color={statusColors[task.status]} style={{ marginRight: 4 }} />
//                                             <Text style={{ fontSize: 12, color: statusColors[task.status], fontWeight: '600' }}>
...
//     modalContent: { padding: 20, borderRadius: 16, marginHorizontal: 16 },
//     headerText: { fontSize: 24, fontWeight: '700', marginBottom: 16 },
//     taskCard: { borderRadius: 16, elevation: 4, shadowColor: '#000', shadowOpacity: 0.1, shadowRadius: 8 },
//     taskHeader: { flexDirection: 'row', alignItems: 'center', marginBottom: 8 },
//     taskTitle: { fontSize: 18, fontWeight: '700' },
//     row: { flexDirection: 'row', alignItems: 'center', marginBottom: 6, paddingInline:2 },
...
//     actionsRow: { flexDirection: 'row', justifyContent: 'space-around', alignItems: 'center', marginTop: 12 },
//     statusContainer: { flexDirection: 'row', alignItems: 'center', backgroundColor: '#F5F5F5', paddingHorizontal: 8, paddingVertical: 4, borderRadius: 12 },
//     remarkInput: { borderRadius: 8, paddingHorizontal: 12, marginBottom: 12 },
// });
...
//                                                 {task.remarks.map((remark, index) => (
//                                                     <View key={index} style={styles.remarkChip}>
//                                                         <Ionicons name="chatbubble-ellipses-outline" size={12} color="#333" style={{ marginRight: 4 }} />
//                                                         <Text style={{ fontSize: 12, color: '#333' }}>{remark}</Text>
//                                                     </View>
//                                                 ))}
//                                             </View>
...
//                                             />
//                                             <View style={styles.statusContainer}>
//                                                 <Ionicons name="ellipse" size={10} color={statusColors[task.status]} style={{ marginRight: 6 }} />
//                                                 <Text style={{ fontSize: 12, color: statusColors[task.status], fontWeight: '600' }}>
//                                                     {task.status.toUpperCase()}
//                                                 </Text>
//                                             </View>
...
//     taskCard: { borderRadius: 16, elevation: 3, marginBottom: 16, padding: 4 },
//     taskHeader: { flexDirection: 'row', alignItems: 'center', marginBottom: 8 },
//     taskTitle: { fontSize: 17, fontWeight: '600' },
//     row: { flexDirection: 'row', alignItems: 'center', marginBottom: 6 },
//     remarksWrapper: { flexDirection: 'row', flexWrap: 'wrap', marginTop: 6 },
//     remarkChip: {
//         flexDirection: 'row',
//         alignItems: 'center',
