    ...
    const togglePushNotifications = async (value) => {
        ...
        try {
            ...
            if (value) {
                ...
                const fcmToken = await messaging().getToken();
                if (!savedTokens.includes(fcmToken)) savedTokens.push(fcmToken);

                await userDocRef.set(
                    { fcmTokens: savedTokens, notificationPreferences: { ...preferences, push: true } },
                    { merge: true }
                );
                ...
                await userDocRef.set(
                    { fcmTokens: savedTokens, notificationPreferences: { ...preferences, push: false } },
                    { merge: true }
                );
